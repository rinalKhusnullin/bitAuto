...
а величина дорожного просвета равняется 192 миллиметрам.', 'Toyota LandCruiser пятиместный кроссовер.
Его габаритные размеры составляют: длина 4550 мм,
ширина 1840 мм, высота 1690 мм, колесная база 2700 мм,
...
премиальный комфорт, впечатляющие ходовые качества и особый характер.', 'Седан Toyota Corolla нового поколения — эталон среди автомобилей бизнес-класса,
который по праву удерживает лидирующие позиции в своем сегменте.
Он построен на модульной архитектуре TNGA, которая обеспечивает
владельцам весомые бонусы и отличные тех характеристики — свежий дизайн,
...
двух дверного купе или кабриолет.','Toyota Yaris начала производиться с 1998 года и показывала уверенный спрос
на рынке вплоть до 2007 года, после чего автомобиль сняли с конвейера.
За всю историю производства автомобиль получил 2 поколения, которые включали
рестайлинг и несколько кузовных вариаций. Toyota Yaris выпускались в форм-факторе
...
204 лошадиных сил.', 'VolksWagen Golf – минивэн M-класса, передний и полный привод.
 Механика и робот. Бензиновые и дизельные двигатели мощностью от 84 до
204 лошадиных сил.
...
одноимённого ветра.', 'VolksWagen Sirocco — семейство среднеразмерных автомобилей компании Volkswagen,
 производившееся с 1973 по 2022 год. Название Sirocco произошло от
одноимённого ветра.
...
и 13 мм сзади.', true, CURRENT_DATE(), 5995000,3,4,2),
       (13, 'VolksWagen beatle', 'VolksWagen beatle- это модель Гольф класса, выпускающаяся в двух вариантах
...
Его габаритные размеры составляют: длина 4550 мм,
ширина 1840 мм, высота 1690 мм, колесная база 2700 мм,
а величина дорожного просвета равняется 192 миллиметрам.', 'VolksWagen Tiguan пятиместный кроссовер.
Его габаритные размеры составляют: длина 4550 мм,
ширина 1840 мм, высота 1690 мм, колесная база 2700 мм,
а величина дорожного просвета равняется 192 миллиметрам.
Такой клиренс свойственен автомобилям, подготовленным к
...
Он построен на модульной архитектуре TNGA, которая обеспечивает
владельцам весомые бонусы и отличные тех характеристики — свежий дизайн,
премиальный комфорт, впечатляющие ходовые качества и особый характер.', 'Седан VolksWagen Polo нового поколения — эталон среди автомобилей бизнес-класса,
который по праву удерживает лидирующие позиции в своем сегменте.
Он построен на модульной архитектуре TNGA, которая обеспечивает
владельцам весомые бонусы и отличные тех характеристики — свежий дизайн,
премиальный комфорт, впечатляющие ходовые качества и особый характер.
...
двух дверного купе или кабриолет.','VolksWagen Touareg начала производиться с 1998 года и показывала уверенный спрос
на рынке вплоть до 2007 года, после чего автомобиль сняли с конвейера.
За всю историю производства автомобиль получил 2 поколения, которые включали
рестайлинг и несколько кузовных вариаций. VolksWagen Touareg выпускались в форм-факторе
двух дверного купе или кабриолет.
...
часть кузова и комфортабельный просторный салон с полуспортивными креслами для переднего ряда.', true, CURRENT_DATE(), 7774000,3,2,1),
 ...
 Механика и робот. Бензиновые и дизельные двигатели мощностью от 84 до
204 лошадиных сил.', 'Nissan Juke – минивэн M-класса, передний и полный привод.
 Механика и робот. Бензиновые и дизельные двигатели мощностью от 84 до
204 лошадиных сил.
...
масса ящичков, кармашков и полочек, призванных поднять комфорт на новый уровень.', true, CURRENT_DATE(), 2220000,4,2,2),
 ...
 производившееся с 1973 по 2022 год. Название Sirocco произошло от
одноимённого ветра.', 'Nissan Almera — семейство среднеразмерных автомобилей компании Nissan,
 производившееся с 1973 по 2022 год. Название Sirocco произошло от
одноимённого ветра.
...
и 13 мм сзади.', true, CURRENT_DATE(), 1140000,4,3,2),
       (19, 'Nissan Qashqai', 'Nissan Qashqai- это модель Гольф класса, выпускающаяся в двух вариантах
исполнения: пятидверный хэтчбек и седан.', 'Мазда 6- это модель Гольф класса, выпускающаяся в двух вариантах
исполнения: пятидверный хэтчбек и седан.
Его габаритные размеры составляют:
длина 4460 мм, ширина 1795 мм, высота 1435 мм, а колесная база- 2725 мм.
...
Его габаритные размеры составляют: длина 4550 мм,
ширина 1840 мм, высота 1690 мм, колесная база 2700 мм,
а величина дорожного просвета равняется 192 миллиметрам.', 'Lexus RX300 пятиместный кроссовер.
Его габаритные размеры составляют: длина 4550 мм,
ширина 1840 мм, высота 1690 мм, колесная база 2700 мм,
а величина дорожного просвета равняется 192 миллиметрам.
Такой клиренс свойственен автомобилям, подготовленным к
...
и несколькими пассажирами на борту.', true, CURRENT_DATE(), 2754000, 5,2,1),
       (21,'Lexus GS300','Седан Lexus GS300 нового поколения — эталон среди автомобилей бизнес-класса,
который по праву удерживает лидирующие позиции в своем сегменте.
Он построен на модульной архитектуре TNGA, которая обеспечивает
владельцам весомые бонусы и отличные тех характеристики — свежий дизайн,
премиальный комфорт, впечатляющие ходовые качества и особый характер.', 'Седан 21. Lexus GS300 нового поколения — эталон среди автомобилей бизнес-класса,
который по праву удерживает лидирующие позиции в своем сегменте.
Он построен на модульной архитектуре TNGA, которая обеспечивает
владельцам весомые бонусы и отличные тех характеристики — свежий дизайн,
премиальный комфорт, впечатляющие ходовые качества и особый характер.
...
двух дверного купе или кабриолет.','Lexus ES300 начала производиться с 1998 года и показывала уверенный спрос
на рынке вплоть до 2007 года, после чего автомобиль сняли с конвейера.
За всю историю производства автомобиль получил 2 поколения, которые включали
рестайлинг и несколько кузовных вариаций. Lexus ES300 выпускались в форм-факторе
двух дверного купе или кабриолет.
...
часть кузова и комфортабельный просторный салон с полуспортивными креслами для переднего ряда.', true, CURRENT_DATE(), 3600000,5,3,1),
 ...
 Механика и робот. Бензиновые и дизельные двигатели мощностью от 84 до
204 лошадиных сил.', 'Audi 5 – минивэн M-класса, передний и полный привод.
 Механика и робот. Бензиновые и дизельные двигатели мощностью от 84 до
204 лошадиных сил.
...
масса ящичков, кармашков и полочек, призванных поднять комфорт на новый уровень.', true, CURRENT_DATE(), 2770000,6,4,1),
 ...
 производившееся с 1973 по 2022 год. Название Sirocco произошло от
одноимённого ветра.', 'Audi 6 — семейство среднеразмерных автомобилей компании Volkswagen,
 производившееся с 1973 по 2022 год. Название Sirocco произошло от
одноимённого ветра.
...
исполнения: пятидверный хэтчбек и седан.', 'Audi 8- это модель Гольф класса, выпускающаяся в двух вариантах
исполнения: пятидверный хэтчбек и седан.
Его габаритные размеры составляют:
длина 4460 мм, ширина 1795 мм, высота 1435 мм, а колесная база- 2725 мм.
Дорожный просвет довольно скромный. Между нижней точкой днища и асфальтом
...
Его габаритные размеры составляют: длина 4550 мм,
ширина 1840 мм, высота 1690 мм, колесная база 2700 мм,
а величина дорожного просвета равняется 192 миллиметрам.', 'Toyota Rav4 пятиместный кроссовер.
Его габаритные размеры составляют: длина 4550 мм,
ширина 1840 мм, высота 1690 мм, колесная база 2700 мм,
а величина дорожного просвета равняется 192 миллиметрам.
Такой клиренс свойственен автомобилям, подготовленным к
...
Он построен на модульной архитектуре TNGA, которая обеспечивает
владельцам весомые бонусы и отличные тех характеристики — свежий дизайн,
премиальный комфорт, впечатляющие ходовые качества и особый характер.', 'Toyota Alphard нового поколения — эталон среди автомобилей бизнес-класса,
который по праву удерживает лидирующие позиции в своем сегменте.
Он построен на модульной архитектуре TNGA, которая обеспечивает
владельцам весомые бонусы и отличные тех характеристики — свежий дизайн,
премиальный комфорт, впечатляющие ходовые качества и особый характер.
...
двух дверного купе или кабриолет.','Mazda 5 начала производиться с 1998 года и показывала уверенный спрос
на рынке вплоть до 2007 года, после чего автомобиль сняли с конвейера.
За всю историю производства автомобиль получил 2 поколения, которые включали
рестайлинг и несколько кузовных вариаций. Mazda 5 выпускались в форм-факторе
двух дверного купе или кабриолет.
...
часть кузова и комфортабельный просторный салон с полуспортивными креслами для переднего ряда.', true, CURRENT_DATE(), 888000,1,6,2),
 ...
 Механика и робот. Бензиновые и дизельные двигатели мощностью от 84 до
204 лошадиных сил.', ' Lexus LM – минивэн M-класса, передний и полный привод.
 Механика и робот. Бензиновые и дизельные двигатели мощностью от 84 до
204 лошадиных сил.
...
масса ящичков, кармашков и полочек, призванных поднять комфорт на новый уровень.', true, CURRENT_DATE(), 1110000,5,5,1),
 ...
 производившееся с 1973 по 2022 год. Название Sirocco произошло от
одноимённого ветра.', 'Nissan Quest — семейство среднеразмерных автомобилей компании Nissan,
 производившееся с 1973 по 2022 год. Название Sirocco произошло от
одноимённого ветра.
